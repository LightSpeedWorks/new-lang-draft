...
//######################################################################
inherits(IfElseSyntax, StatementSyntax);
function IfElseSyntax(opExprStmts) {
  StatementSyntax.call(this, 200);
...
// [else stmt]
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
IfElseSyntax.prototype.run = function run(ctx) {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
IfElseSyntax.prototype.toString = function toString() {
  var s = '';
  for (var i in this.opExprStmts) {
    var elem = this.opExprStmts[i];
    if (elem.op === 'if')
